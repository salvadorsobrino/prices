...
import com.prueba.prices.infraestructure.adapters.output.persistance.mapper.PricePersistenceMapper;
...
public class PricePersistenceAdapter implements PricePersistencePort {
    ...
    @Override
    public Price findByPriorityPrice(LocalDateTime applicationDate, Long productId, Long brandId) {
